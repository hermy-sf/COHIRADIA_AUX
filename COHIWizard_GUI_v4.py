...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pushButton_InsertHeader, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.radioButton_WAVEDIT, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidget_3, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidget_starttime, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidget, 0, 0, 3, 3)
        self.label_Filename3 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_Filename3.setText("")
        self.label_Filename3.setObjectName("label_Filename3")
        self.gridLayout.addWidget(self.label_Filename3, 3, 1, 1, 4)
        self.tabWidget.addTab(self.tab_1, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.gridLayoutWidget_4 = QtWidgets.QWidget(self.tab_2)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(20, 90, 991, 471))
        ...
        self.gridLayout_5.addWidget(self.graphicsView_2, 1, 0, 1, 1)
        ...
        self.label_Filename2 = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.label_Filename2.setText("")
        self.label_Filename2.setObjectName("label_Filename2")
        self.gridLayout_4.addWidget(self.label_Filename2, 6, 1, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.horizontalScrollBar, 5, 0, 1, 5)
        ...
        self.spinBoxminPeakwidth.setMinimum(0)
        self.spinBoxminPeakwidth.setMaximum(2000)
        self.spinBoxminPeakwidth.setSingleStep(10)
        ...
        self.spinBoxminPeakDistance.setMinimum(0)
        ...
        self.gridLayout_3.addWidget(self.progressBar_2, 10, 0, 1, 7)
        ...
        self.gridLayout_3.addWidget(self.radioButton_plotpreview, 10, 7, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_6.setObjectName("label_6")
        self.gridLayout_3.addWidget(self.label_6, 3, 0, 1, 1)
        self.label_Filename1 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_Filename1.setText("")
        self.label_Filename1.setObjectName("label_Filename1")
        self.gridLayout_3.addWidget(self.label_Filename1, 11, 1, 1, 7)
        self.label_11 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_11.setObjectName("label_11")
        self.gridLayout_3.addWidget(self.label_11, 11, 0, 1, 1)
        self.lineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.lineEdit.setObjectName("lineEdit")
        self.gridLayout_3.addWidget(self.lineEdit, 4, 1, 1, 7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_3.setText(_translate("MainWindow", "Resampler not yet implemented"))
        self.graphicsView_2.setToolTip(_translate("MainWindow", "space for spectrum plot"))
        self.label_9.setToolTip(_translate("MainWindow", "minimum SNR for auto-selection of peaks"))
        ...
        self.lineEdit.setText(_translate("MainWindow", "o"))
